...
public class AssociationServiceImpl implements AssociationService {
    ...
    @Override
    public AssociationVO selectById(Integer id) {
        AssociationInfo associationInfo = associationMapper.selectById(id);
        ...
        BeanUtils.copyProperties(associationInfo,associationVO);
